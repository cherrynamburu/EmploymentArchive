...
namespace EmploymentArchive
{
    class Program
    {
        static void HandleRetrieveOperation()
        {
            while (true)
            {
                Console.Write("Single Job -0 or Multiple Jobs -1 | Pick Number : ");
                ...
                {                   
                    ...
                    Console.WriteLine("- - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - - -");
                    SqlServer.RetrieveJob();                
                    break;
                }
                if (temp == 1)
                {
                    Console.WriteLine(" - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - -");
                    SqlServer.RetrieveJobs();
                    Console.WriteLine(" - - - - - - - - - - - - - - - - - - - - - - - - -  - - - - - - -");
                    break;
                }
                Console.WriteLine("Choose from 0 and 1 : ");
            }
